...
const Footer = () => {
  return (
    <footer className="mt-7 lg:mt-12 w-full lg:max-w-screen-md flex flex-col justify-center items-center mx-auto">
      ...
      <AnimationContainer customClassName="w-full grid place-items-center grid-cols-3 gap-1 lg:gap-4 pb-8 sm:grid-cols-3 mx-3">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <ExternalLink href="https://github.com/Mizanur6674">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
        ...
        <div className="flex flex-col space-y-4">
          ...
          <ExternalLink href="https://linkedin.com/in/mizan6674">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <ExternalLink href="https://europa.eu/europass/eportfolio/screen/share/1fb76537-4bdd-49d5-97e1-49eeb1e16b68?lang=en">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
